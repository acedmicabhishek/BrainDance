...
global vga_trampoline_off_start
global vga_trampoline_off_end

%define BASE 0x7000

vga_trampoline_off_start:
    cli
...
.get_ip:
    pop ebx
    sub ebx, .get_ip - vga_trampoline_off_start
...
gdt_real_ptr:
    ...
    dd BASE + gdt_real_mode - vga_trampoline_off_start
